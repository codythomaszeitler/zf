...
export function getAccountSObjectDescribeResult() : SObjectDescribeResult {
	const accountSObjectDescribeResult = {
		...
		"result": {
			...
			"recordTypeInfos": [
				{
					...
					"urls": {
						"layout": "/services/data/v61.0/sobjects/Account/describe/layouts/012000000000000AAA"
					}
				}
			],
			"replicateable": true,
			...
			"updateable": true,
			"urls": {
				"compactLayouts": "/services/data/v61.0/sobjects/Account/describe/compactLayouts",
