...
export function getAccountSObjectDescribeResult(): SObjectDescribeResult {
	const accountSObjectDescribeResult = {
		"status": 0,
		"result": {
			"actionOverrides": [
				{
			...
			"fields": [
				...
				},
				{
					...
					"relationshipName": "Test_Lead_Lookup__r",
					"relationshipOrder": null,
					"restrictedDelete": false,
					"restrictedPicklist": false,
					"scale": 0,
			...
			"recordTypeInfos": [
				{
					...
					"urls": {
						"layout": "/services/data/v62.0/sobjects/Account/describe/layouts/012000000000000AAA"
					}
				}
			],
			"replicateable": true,
			...
			"updateable": true,
			"urls": {
				"compactLayouts": "/services/data/v62.0/sobjects/Account/describe/compactLayouts",
				"rowTemplate": "/services/data/v62.0/sobjects/Account/{ID}",
				"approvalLayouts": "/services/data/v62.0/sobjects/Account/describe/approvalLayouts",
				...
				"listviews": "/services/data/v62.0/sobjects/Account/listviews",
				"describe": "/services/data/v62.0/sobjects/Account/describe",
				"uiNewRecord": "https://playful-bear-5awd3r-dev-ed.my.salesforce.com/001/e",
				"quickActions": "/services/data/v62.0/sobjects/Account/quickActions",
				"layouts": "/services/data/v62.0/sobjects/Account/describe/layouts",
				"sobject": "/services/data/v62.0/sobjects/Account"
			}
		},
		"warnings": []
	};
	return accountSObjectDescribeResult;
}