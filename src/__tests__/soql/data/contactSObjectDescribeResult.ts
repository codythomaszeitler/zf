...
export function getContactSObjectDescribeResult() : SObjectDescribeResult{
    const contactSObjectDescribe = {
        "status": 0,
        "result": {
            "actionOverrides": [],
            "activateable": false,
            ...
            "childRelationships": [
                ...
                {
                    "cascadeDelete": false,
                    "childSObject": "ContactCleanInfoChangeEvent",
                    "deprecatedAndHidden": false,
                    "field": "ContactId",
                    "junctionIdListNames": [],
                    "junctionReferenceTo": [],
                ...
                {
                    "cascadeDelete": false,
                    "childSObject": "EmailBounceEvent",
                    "deprecatedAndHidden": false,
                    "field": "BouncedObjectId",
                    "junctionIdListNames": [],
                    "junctionReferenceTo": [],
                    "relationshipName": null,
                    "restrictedDelete": false
                ...
                {
                    "cascadeDelete": false,
                    "childSObject": "Favorite__c",
                    "deprecatedAndHidden": false,
                    "field": "Contact__c",
                    "junctionIdListNames": [],
                    "junctionReferenceTo": [],
                    "relationshipName": "Favorites__r",
                    "restrictedDelete": false
                },
                {
                    "cascadeDelete": false,
                ...
                {
                    "cascadeDelete": false,
                    "childSObject": "FlowOrchestrationInstance",
                    "deprecatedAndHidden": false,
                    "field": "TriggeringRecordId",
                    "junctionIdListNames": [],
                    "junctionReferenceTo": [],
                    "relationshipName": "FlowOrchestrationInstances",
                    "restrictedDelete": false
                },
                {
                    "cascadeDelete": false,
                ...
                {
                    "cascadeDelete": false,
                    "childSObject": "Offer__c",
                    "deprecatedAndHidden": false,
                    "field": "Contact__c",
                    "junctionIdListNames": [],
                    "junctionReferenceTo": [],
                    "relationshipName": "Offers__r",
                    "restrictedDelete": false
                },
                {
                    "cascadeDelete": true,
                ...
                {
                    "cascadeDelete": false,
                    "childSObject": "UserEmailPreferredPersonChangeEvent",
                    "deprecatedAndHidden": false,
                    "field": "PersonRecordId",
                    "junctionIdListNames": [],
                    "junctionReferenceTo": [],
            ...
            "fields": [
                ...
                },
                {
                    ...
                    "byteLength": 3900,
                    "calculated": true,
                    "calculatedFormula": "Account.AccountNumber",
                    "cascadeDelete": false,
                    "caseSensitive": false,
                    "compoundFieldName": null,
                    "controllerName": null,
            ...
            "recordTypeInfos": [
                {
                    ...
                    "urls": {
                        "layout": "/services/data/v62.0/sobjects/Contact/describe/layouts/012000000000000AAA"
                    }
                }
            ],
            "replicateable": true,
            ...
            "updateable": true,
            "urls": {
                "compactLayouts": "/services/data/v62.0/sobjects/Contact/describe/compactLayouts",
                "rowTemplate": "/services/data/v62.0/sobjects/Contact/{ID}",
                "approvalLayouts": "/services/data/v62.0/sobjects/Contact/describe/approvalLayouts",
                "uiDetailTemplate": "https://playful-bear-5awd3r-dev-ed.my.salesforce.com/{ID}",
                "uiEditTemplate": "https://playful-bear-5awd3r-dev-ed.my.salesforce.com/{ID}/e",
                "listviews": "/services/data/v62.0/sobjects/Contact/listviews",
                "describe": "/services/data/v62.0/sobjects/Contact/describe",
                "uiNewRecord": "https://playful-bear-5awd3r-dev-ed.my.salesforce.com/003/e",
                "quickActions": "/services/data/v62.0/sobjects/Contact/quickActions",
                "layouts": "/services/data/v62.0/sobjects/Contact/describe/layouts",
                "sobject": "/services/data/v62.0/sobjects/Contact"
            }
        },
        "warnings": []
    };
    return contactSObjectDescribe;
}